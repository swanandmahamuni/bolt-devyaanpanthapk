...
export const DivineBackground = ({ stable = false }: { stable?: boolean }) => {
  ...
  const flowers = useMemo(
    () => [
      { src: sonchafa1, top: "-4%", left: "-8%", size: 90, rotate: -25, delay: "0s", dur: "18s" },
      { src: sonchafa2, top: "12%", right: "-6%", size: 80, rotate: 15, delay: "4s", dur: "22s" },
      { src: sonchafa3, top: "58%", left: "-10%", size: 85, rotate: 40, delay: "8s", dur: "20s" },
      { src: sonchafa1, top: "78%", right: "-7%", size: 75, rotate: -30, delay: "12s", dur: "24s" },
      { src: sonchafa2, top: "38%", left: "-5%", size: 70, rotate: 60, delay: "2s", dur: "16s" },
    ],
    [],
  );
