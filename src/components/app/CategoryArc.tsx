...
export const CategoryArc = () => {
  ...
  const radius = 92; // px — compact bottom-right arc
  ...
  return (
    <div className="relative">
      {/* Arc of icons */}
      <div
        className="relative ml-auto h-24 w-full touch-pan-y select-none"
        ...
        {CATEGORIES.map((c, i) => {
          ...
          return (
            <button
              ...
              className={cn(
                "icon-3d absolute left-[58%] top-0 flex w-16 -translate-x-1/2 flex-col items-center gap-1",
            ...
            >
              <span className="icon-3d__face grid h-10 w-10 place-items-center rounded-2xl">
